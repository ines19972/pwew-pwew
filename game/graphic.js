function init()
{
    ...
    player2 = new Player("player2", 0xffff00, new THREE.Vector2(80, 3), 0);
        ...
        for (y = minY; y <= maxY; y = y+sizeOfTileY){
            ...
            if (x == 0  && y == 0)
            {
                tmpGround = new THREE.Mesh(
                    ...
                    new THREE.MeshLambertMaterial({color: 0x37ffe1, transparent: true, opacity: 0.6}));
...
{
    pointLight = new THREE.PointLight(color, 100, 500);
